...
export const listings: Listing[] = [
  { id: 'notedrop', name: 'Notedrop', mark: 'ND', tagline: 'Meetings into decisions.', category: 'AI', totalBid: 1250, weekBid: 820, todayBid: 310, dealLabel: '70% OFF', dealDetails: '$36 for the first year, then the standard annual price.', coupon: 'DEAL70', clicks: 4821, claims: 184, url: 'https://example.com/notedrop', age: '2h ago' },
